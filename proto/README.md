...
`v0.1.0-pre.3`, the same release the upstream test suites run against (pinned in
...
`options.proto`, and `sandbox.proto` from that upstream tag and builds the workspace to
